...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-card-border bg-white px-4 py-4 shadow-sm">
...
export function LessonReportView({
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="mt-8 rounded-2xl border border-card-border bg-white p-5 shadow-sm">
      ...
      <div className="mt-10 rounded-2xl border border-card-border bg-white px-5 py-6 shadow-sm">
